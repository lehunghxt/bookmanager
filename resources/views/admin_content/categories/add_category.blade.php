    ...
    <div class="card-body">
        <form method="POST" action="{{ url('add-category') }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="cate_name" name="cate_name" aria-describedby="" placeholder="Enter Cate Name">
               @if ($errors->has('cate_name'))
                    <span class="text-danger">{{ $errors->first('cate_name') }}</span>
                @endif
            </div>
            <div class="form-check">
              <input type="checkbox" value="951236" class="form-check-input" id="status" name="status">
